...
| `backendSurface` | Backend jobs/rendering, dense matchers/search/audit, pair covariance, dense surface, synthetic truth, inverse warp, and raster paths | 172 |
...
The validated July 13, 2026 baseline is 625/625 with zero failures and zero
incomplete tests.
