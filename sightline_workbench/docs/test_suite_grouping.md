...
| `backendSurface` | Backend jobs/rendering, dense matchers/search/audit, dense surface, synthetic truth, inverse warp, and raster paths | 165 |
...
The validated July 13, 2026 baseline is 618/618 with zero failures and zero
incomplete tests.
