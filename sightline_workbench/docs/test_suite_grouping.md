...
| `backendSurface` | Backend jobs/rendering, dense matchers/search/audit, pair covariance, robust multi-ray and surface-fusion SDK/audit, dense surface, synthetic truth, inverse warp, and raster paths | 200 |
...
The validated July 13, 2026 baseline is 653/653 with zero failures and zero
incomplete tests.
