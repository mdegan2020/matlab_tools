...
| `backendSurface` | Backend jobs/rendering, dense matchers/search/audit, pair covariance, robust multi-ray reconstruction, dense surface, synthetic truth, inverse warp, and raster paths | 185 |
...
The validated July 13, 2026 baseline is 638/638 with zero failures and zero
incomplete tests.
