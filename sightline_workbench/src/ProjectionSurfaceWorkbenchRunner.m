classdef ProjectionSurfaceWorkbenchRunner < handle
    ...
    methods
        ...
        function outcome = run(runner, state, runtimeControl)
            ...
            for index = 1:numel(entries)
                ...
                try
                    ...
                    pairRecords = runner.recordsForResult(entry, result, ...
                        matcherId, state.MaximumObservations);
            ...
            [pointSet, reconstructionStatus, association] = ...
                runner.reconstruct(records, associationOptions);
    ...
    methods (Static, Access = private)
        ...
        function records = emptyRecords()
            records = struct("RecordId", {}, "PairId", {}, ...
                "ViewIds", {}, "PassIds", {}, "ObservationIds", {}, ...
                "SourceObservationsPixels", {}, "RayOriginsWorld", {}, ...
                "RayVectorsWorld", {}, "MatchState", {}, "Score", {}, ...
                "Confidence", {}, "TextureScore", {}, ...
                "NavigationWeights", {}, "RadiometricValues", {}, ...
                "RadiometricConsistency", {}, "VisibilityStates", {}, ...
                "ProvisionalPointWorld", {}, ...
        ...
        function outcome = emptyOutcome(preflight)
            outcome = struct(Format= ...
                ...
                Diagnostics=struct(), Provenance=struct(), ...
