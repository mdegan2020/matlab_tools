classdef ProjectionBackendRenderPlan
    ...
    methods (Static)
        function plan = compile(scene, options, preparedLayers)
            ...
            plan.IncludeQueryCoordinates = options.IncludeQueryCoordinates;
            plan.WorkingPrecision = options.WorkingPrecision;
        ...
        function plan = validate(plan)
            ...
            requiredFields = ["Format", "Version", "RuntimeOnly", ...
                ...
                "IncludeLayerReadbacks", "IncludeQueryCoordinates", ...
                "WorkingPrecision", "UseGPU", "GpuInfo", ...
            ...
            plan.IncludeQueryCoordinates = ...
                ProjectionBackendRenderPlan.validateLogicalScalar( ...
                plan.IncludeQueryCoordinates, "IncludeQueryCoordinates");
            plan.WorkingPrecision = ...
                ProjectionBackendRenderPlan.validateWorkingPrecision( ...
                plan.WorkingPrecision);
        ...
        function summary = summary(plan)
            ...
            summary.IncludeQueryCoordinates = plan.IncludeQueryCoordinates;
            summary.WorkingPrecision = plan.WorkingPrecision;
    ...
    methods (Static, Access = private)
        ...
        function precision = validateWorkingPrecision(precision)
            precision = lower(string(precision));
            if ~isscalar(precision) || ...
                    ~ismember(precision, ["double", "single"])
                error("ProjectionBackendRenderPlan:invalidOptions", ...
