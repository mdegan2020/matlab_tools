classdef ProjectionAlignmentFeatureMatcher
    ...
    methods (Static, Access = private)
        ...
        function feature = detectLayerImage(layerImage, detector, detectorOptions)
            ...
            points = ProjectionAlignmentFeatureMatcher.selectFirst( ...
        ...
        function feature = emptyFeature()
            feature = struct(LayerIndex=0, LayerId="", PairIndex=0, ...
                ...
                MetricKeptCount=0, SupportKeptCount=0, SelectedCount=0, ...
                MetricRejectedCount=0, MaskRejectedCount=0, ...
                DescriptorRejectedCount=0, MetricThreshold=[], ...
        ...
        function points = selectFirst(points, maxFeatures)
            count = ProjectionAlignmentFeatureMatcher.pointCount(points);
            if count > maxFeatures
                points = points(1:maxFeatures);
            end
        end
        ...
        function records = featureDiagnosticRecords(features)
            records = repmat(struct(LayerIndex=0, LayerId="", PairIndex=0, ...
                ...
                MaskRejectedCount=0, SelectedCount=0, ...
