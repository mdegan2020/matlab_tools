classdef ProjectionAlignmentNetworkSolver
    ...
    methods (Static)
        function result = solve(scene, matchResult, options, runtimeControl)
            ...
            monitor.setStage("selectingSolveEvidence", struct( ...
                RefinedObservationCount=refinement.Diagnostics.RefinedCount, ...
                SourceReadCount=refinement.Diagnostics.SourceReadCount, ...
                SourcePixelsRead=refinement.Diagnostics.SourcePixelsRead));
            ...
            result.Diagnostics.Network.SourceRefinement = ...
                refinement.Diagnostics;
            result.Diagnostics.Network.SourceRefinementPairs = ...
                refinement.PairDiagnostics;
            result.Diagnostics.Network.EvidenceSelection = ...
                selection.Diagnostics;
            result.Diagnostics.Network.RefinedFiltering = ...
                refinedFiltered.Diagnostics;
            result.Diagnostics.Network.CompleteMatchLedger = ...
                selection.MatchResult.MatchLedger;
            ...
            work.RefinedObservationCount = refinement.Diagnostics.RefinedCount;
            work.SourcePatchReadCount = refinement.Diagnostics.SourceReadCount;
            work.SourcePatchPixelsRead = refinement.Diagnostics.SourcePixelsRead;
            work.SourcePatchBytesRead = refinement.Diagnostics.SourceBytesRead;
            work.SelectedObservationCount = ...
                selection.Diagnostics.SelectedRecordCount;
            work.SpatialRedundancyCount = ...
                selection.Diagnostics.SpatialRedundancyCount;
