    ...
    methods (Static)
        function comparison = evaluate(scene, request, options)
            ...
            comparison = struct( ...
                ...
                Modes=summaries, DefaultDecision="fullSourceInverseWarp", ...
                CurrentDefault="fullSourceInverseWarp"));
        end
    ...
    methods (Static, Access = private)
        ...
        function counts = filterStageCounts(filtered)
            ...
            counts = repmat(struct(Pair=[0 0], Initial=0, OverlapMask=0, ...
                ...
                EpipolarCoplanarity=0, NativeDisplacement=0, Radial=0, ...
                Final=0), 1, numel(pipelines));
            for k = 1:numel(pipelines)
                ...
                counts(k) = struct(Pair=pipelines(k).Pair, ...
                    ...
                    EpipolarCoplanarity=stage.EpipolarCoplanarity, ...
        ...
        function summary = solveSummary(scene, filtered, alignmentOptions, runSolve)
            summary = struct(Attempted=false, Status="notRun", ...
                ...
                CorrectionNormDegrees=NaN, MaxAbsCorrectionDegrees=NaN, ...
                SolvedCorrections=struct([]));
            ...
            try
                ...
                corrections = reshape( ...
                    ...
                    3, []).';
                summary.CorrectionNormDegrees = norm(corrections, "fro");
                summary.MaxAbsCorrectionDegrees = max(abs(corrections), [], "all");
                summary.SolvedCorrections = result.SolvedCorrections;
            catch ME
