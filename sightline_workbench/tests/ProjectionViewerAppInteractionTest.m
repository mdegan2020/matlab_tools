classdef ProjectionViewerAppInteractionTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testImageContextMenuContainsViewerCommands(testCase)
            ...
            rebuildMenu = ProjectionViewerAppInteractionTest.findMenuItem( ...
            ...
            testCase.verifyEqual( ...
                ...
                string(rebuildMenu.Text) string(helpMenu.Text) ...
                string(crosshairMenu.Text) ...
                string(alignmentPanelMenu.Text) string(blendMenu.Text)], ...
                ["Save" "Load" "Cycle" ...
                "Reset scene and corrections..." "Rebuild viewport" ...
                "Help" "Crosshair" ...
        ...
        function testBlendModeContextMenuUpdatesVisibleLayersAndPreview(testCase)
            ...
            cyanLayerIndex = 3 - actualRedLayerIndex;
            ...
            testCase.verifyEqual(actualRedLayerIndex, ...
                expectedRedLayerIndex);
            testCase.verifyEqual(state.SelectedLayerIndex, ...
                actualRedLayerIndex);
            testCase.verifyEqual( ...
                state.Layers(actualRedLayerIndex).Alpha, 0.50, ...
                AbsTol=ProjectionViewerAppInteractionTest.Tol);
            testCase.verifyEqual( ...
                layerSurfaces(actualRedLayerIndex).FaceAlpha, 0.50, ...
                AbsTol=ProjectionViewerAppInteractionTest.Tol);
            testCase.verifyEqual( ...
                layerSurfaces(cyanLayerIndex).FaceAlpha, 1, ...
                AbsTol=ProjectionViewerAppInteractionTest.Tol);
            alphaSlider = findall(fig, "Tag", "ProjectionViewerAlphaSlider");
            testCase.verifyEqual(alphaSlider.Value, 0.50, ...
                AbsTol=ProjectionViewerAppInteractionTest.Tol);
